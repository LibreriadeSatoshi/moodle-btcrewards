...
$string['setting_min_payout_usd_desc'] = 'Smallest amount, in USD, a student must accumulate before they can claim. Decimal dollars: 0.50 = $0.50, 1 = $1.00, 5 = $5.00. The Lightning rail accepts any amount above this.';
...
$string['setting_allowed_ln_domain'] = 'Allowed Lightning address domain';
$string['setting_allowed_ln_domain_desc'] = 'Only Lightning addresses on this domain can be paid out. Students entering a destination on any other domain are rejected at claim time.';
...
$string['admin_fund_amount_placeholder'] = 'Amount (sats)';
$string['admin_fund_generate'] = 'Generate funding invoice';
$string['admin_fund_invoice_help'] = 'Pay this Lightning invoice from an external wallet to fund the payout wallet. It expires in 1 hour.';
$string['error_balance_unavailable'] = 'Payment service balance unavailable: {$a}';
$string['error_deposit_unavailable'] = 'Could not create funding invoice: {$a}';
...
$string['admin_failed_heading'] = 'Failed payouts';
$string['admin_failed_empty'] = 'No failed payouts.';
...
$string['admin_browse_heading'] = 'All payouts';
$string['admin_browse_status'] = 'Status';
$string['admin_browse_status_any'] = 'Any status';
$string['admin_browse_user'] = 'User';
$string['admin_browse_user_placeholder'] = 'Name or email';
$string['admin_browse_dest'] = 'Destination or txid';
$string['admin_browse_dest_placeholder'] = 'lnbc…, bc1…, or full txid';
$string['admin_browse_from'] = 'From';
$string['admin_browse_to'] = 'To';
$string['admin_browse_apply'] = 'Apply filters';
$string['admin_browse_clear'] = 'Clear';
$string['admin_browse_count'] = '{$a->count} matching payouts';
$string['admin_browse_empty'] = 'No payouts match these filters.';
...
$string['claim_invalid_ln_address'] = 'Only Lightning addresses on the <strong>{$a}</strong> domain are supported (e.g. <code>you@{$a}</code>).';
$string['my_payout_amount_label'] = 'You will receive';
$string['my_address_label'] = 'Where should we send it?';
$string['my_address_placeholder'] = 'you@{$a}';
$string['my_address_help'] = 'Enter your Lightning address on the <code>{$a}</code> domain (e.g. <code>you@{$a}</code>).';
$string['my_address_get_one'] = 'Don\'t have one yet? Create your Lightning address at <a href="https://wallet.libreriadesatoshi.com/" target="_blank" rel="noopener">wallet.libreriadesatoshi.com</a>.';
$string['my_save_address'] = 'Save for next time';
$string['profile_field_lnaddress'] = 'Lightning Address';
$string['profile_field_lnaddress_desc'] = 'Your Lightning address for receiving Bitcoin reward payouts.';
$string['my_ofac_label'] = 'I\'m not in an OFAC-sanctioned jurisdiction';
$string['my_ofac_list'] = 'Currently: Cuba, Iran, North Korea, Syria, and the Crimea, Donetsk, and Luhansk regions of Ukraine.';
$string['my_ofac_required'] = 'You must confirm you are not located in an OFAC-sanctioned jurisdiction before claiming.';
...
$string['my_failed_admin_contact'] = 'This payout failed. Contact the site administrator to release the points so you can claim again.';
$string['payout_status_requeued'] = 'Points returned';
$string['requeue_not_failed'] = 'Only failed payouts can be released.';
