...
$string['setting_min_payout_usd_desc'] = 'Monto mínimo en USD que un estudiante debe acumular antes de poder cobrar. En decimales: 0.50 = USD 0,50, 1 = USD 1,00, 5 = USD 5,00. La red Lightning acepta cualquier monto por encima de este umbral.';
...
$string['setting_allowed_ln_domain'] = 'Dominio permitido para direcciones Lightning';
$string['setting_allowed_ln_domain_desc'] = 'Solo se pueden pagar direcciones Lightning de este dominio. Cualquier otro dominio se rechaza al momento de reclamar.';
...
$string['admin_fund_amount_placeholder'] = 'Monto (sats)';
$string['admin_fund_generate'] = 'Generar invoice de fondeo';
$string['admin_fund_invoice_help'] = 'Pague este invoice Lightning desde una billetera externa para fondear la billetera de pagos. Expira en 1 hora.';
$string['error_balance_unavailable'] = 'Saldo del servicio de pagos no disponible: {$a}';
$string['error_deposit_unavailable'] = 'No se pudo crear el invoice de fondeo: {$a}';
...
$string['admin_browse_heading'] = 'Todos los pagos';
$string['admin_browse_status'] = 'Estado';
$string['admin_browse_status_any'] = 'Cualquier estado';
$string['admin_browse_user'] = 'Usuario';
$string['admin_browse_user_placeholder'] = 'Nombre o email';
$string['admin_browse_dest'] = 'Destino o txid';
$string['admin_browse_dest_placeholder'] = 'lnbc…, bc1…, o txid completo';
$string['admin_browse_from'] = 'Desde';
$string['admin_browse_to'] = 'Hasta';
$string['admin_browse_apply'] = 'Aplicar filtros';
$string['admin_browse_clear'] = 'Limpiar';
$string['admin_browse_count'] = '{$a->count} pagos coinciden';
$string['admin_browse_empty'] = 'No hay pagos que coincidan con estos filtros.';
...
$string['my_below_threshold'] = 'Sigue aprendiendo — necesitas al menos USD {$a} en recompensas sin reclamar para cobrar.';
$string['claim_invalid_ln_address'] = 'Solo se aceptan direcciones Lightning del dominio <strong>{$a}</strong> (por ejemplo, <code>vos@{$a}</code>).';
$string['my_payout_amount_label'] = 'Vas a recibir';
$string['my_address_label'] = '¿A dónde lo enviamos?';
$string['my_address_placeholder'] = 'vos@{$a}';
$string['my_address_help'] = 'Ingresa tu Lightning address en el dominio <code>{$a}</code> (por ejemplo, <code>vos@{$a}</code>).';
$string['my_address_get_one'] = '¿Aún no tienes una? Crea tu Lightning address en <a href="https://wallet.libreriadesatoshi.com/" target="_blank" rel="noopener">wallet.libreriadesatoshi.com</a>.';
$string['my_save_address'] = 'Guardar para la próxima vez';
$string['profile_field_lnaddress'] = 'Dirección Lightning';
$string['profile_field_lnaddress_desc'] = 'Tu dirección Lightning para recibir pagos de recompensas en Bitcoin.';
$string['my_ofac_label'] = 'No estoy en una jurisdicción sancionada por OFAC';
$string['my_ofac_list'] = 'Actualmente: Cuba, Irán, Corea del Norte, Siria y las regiones de Crimea, Donetsk y Lugansk de Ucrania.';
$string['my_ofac_required'] = 'Debes confirmar que no estás en una jurisdicción sancionada por OFAC antes de reclamar.';
