...
$string['my_address_warning'] = '⚠ Los pagos son definitivos y no se pueden revertir. Verifica antes de enviar.';
$string['my_ofac_label'] = 'Confirmo que no estoy ubicado ni soy residente de una jurisdicción sancionada por OFAC (actualmente Cuba, Irán, Corea del Norte, Siria y las regiones de Crimea, Donetsk y Lugansk de Ucrania).';
